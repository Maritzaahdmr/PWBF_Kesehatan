...
Route::get('/posyandu/hapus{ID_POSYANDU}','App\Http\Controllers\PosyanduController@hapus');
...
Route::get('/balita/hapus{ID_BALITA}','App\Http\Controllers\BalitaController@hapus');
