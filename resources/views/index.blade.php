...
<head>
  ...
  <link href="https://posyandu.bandungkab.go.id/assets/css/icons/icomoon/styles.css" rel="stylesheet">        
...
<div id="wrapper">
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-6 col-md-6">
              <p class="bold text-left">Senin - Jumat, 08:00 - 16.00 WIB </p>
            </div>
            <div class="col-sm-6 col-md-6">
              <p class="bold text-right">Hub (022) 5897432</p>
            </div>
          </div>
        </div>
      </div>
      <div class="container navigation">
        ...
        <div class="navbar-header page-scroll">
          ...
          <a class="navbar-brand" href="index.html">
                    <img src="https://posyandu.bandungkab.go.id/assets/medicio/img/logo.png" alt="" width="150" height="40" />
                </a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="https://posyandu.bandungkab.go.id/#intro">Home</a></li>
            <li><a href="https://posyandu.bandungkab.go.id/#boxes">Layanan</a></li>
            <li><a href="https://posyandu.bandungkab.go.id/#testimonial">Agenda</a></li>
            <li><a href="/">Statistik</a></li>
            <!-- <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Profil<b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a href="index.html">Visi Misi</a></li>
                <li><a href="index-form.html">Sejarah</a></li>
              </ul>
            </li> -->
            <li><a href="https://posyandu.bandungkab.go.id/YouLogin">Login Posyandu</a></li>
          </ul>
        </div>
        <!-- /.navbar-collapse -->
      </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="wow fadeInDown" data-wow-offset="0" data-wow-delay="0.1s">
                <h2 class="h-ultra">Manfaat Posyandu</h2>
              </div>
              ...
              <div class="well well-trans">
                <div class="wow fadeInRight" data-wow-delay="0.1s">
                  ...
                  <ul class="lead-list">
                    <li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Perbaikan perilaku, keadaan gizi dan kesehatan keluarga.</strong></li>
                    <li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Mendukung perilaku hidup bersih dan sehat.</strong></li>
					          <li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Pencegahan penyakit yang berbasis lingkungan.</strong></li>
                    <li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Pencegahan penyakit dengan imunisasi.</strong></li>
                    <li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Mendukung pelayanan Keluarga Berencana.</strong></li>
                    <li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Mendukung pemberdayaan keluarga dan masyarakat.</strong></li>
                    <li><span class="fa fa-check fa-2x icon-success"></span> <span class="list"><strong>Pusat informasi dan konseling dalam perlindungan anak</strong></li>
				</ul>
                </div>
              </div>
		   </div>
            <div class="col-lg-6">
              <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                <img src="https://posyandu.bandungkab.go.id/assets/medicio/img/dummy/img-1.png" class="img-responsive" alt="" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-sm-3 col-md-3">
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="box text-center">
                ...
                <h4 class="h-bold">Meningkatkan Kualitas Cakupan Layanan Pendidikan</h4>
                <!-- <p>
          ...
          <div class="col-sm-3 col-md-3">
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="box text-center">
                ...
                <h4 class="h-bold">Mengoptimalkan Pelayanan Kesahatan</h4>
                <!-- <p>
                  Lorem ipsum dolor sit amet, nec te mollis utroque honestatis, ut utamur molestiae vix, graecis eligendi ne.
                </p> -->
              </div>
    ...
    <!-- <section id="service" class="home-section nopadding paddingtop-60">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-6">
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <img src="https://posyandu.bandungkab.go.id/assets/medicio/img/dummy/img-1.jpg" class="img-responsive" alt="" />
            </div>
          </div>
          <div class="col-sm-3 col-md-3">
    ...
    <!-- Section: team -->
    <!-- <section id="boxes" class="home-section bg-gray paddingbot-60">
              ...
              <ul>
                <li class="cbp-item psychiatrist">
                  <a href="doctors/member1.html" class="cbp-caption cbp-singlePage">
                    <div class="cbp-caption-defaultWrap">
                      <img src="https://posyandu.bandungkab.go.id/assets/medicio/img/team/1.jpg" alt="" width="100%">
                    </div>
                ...
                <li class="cbp-item cardiologist">
                  <a href="doctors/member2.html" class="cbp-caption cbp-singlePage">
                    <div class="cbp-caption-defaultWrap">
                      <img src="https://posyandu.bandungkab.go.id/assets/medicio/img/team/2.jpg" alt="" width="100%">
                    </div>
                    <div class="cbp-caption-activeWrap">
                      <div class="cbp-l-caption-alignCenter">
                        <div class="cbp-l-caption-body">
                ...
                <li class="cbp-item cardiologist">
                  <a href="doctors/member3.html" class="cbp-caption cbp-singlePage">
                    <div class="cbp-caption-defaultWrap">
                      <img src="https://posyandu.bandungkab.go.id/assets/medicio/img/team/3.jpg" alt="" width="100%">
                    </div>
                    <div class="cbp-caption-activeWrap">
                      <div class="cbp-l-caption-alignCenter">
                        <div class="cbp-l-caption-body">
                ...
                <li class="cbp-item neurologist">
                  <a href="doctors/member4.html" class="cbp-caption cbp-singlePage">
                    <div class="cbp-caption-defaultWrap">
                      <img src="https://posyandu.bandungkab.go.id/assets/medicio/img/team/4.jpg" alt="" width="100%">
                    </div>
                    <div class="cbp-caption-activeWrap">
                      <div class="cbp-l-caption-alignCenter">
                        <div class="cbp-l-caption-body">
      ...
      <div class="container marginbot-50">
        <div class="row">
          <div class="col-lg-8 col-lg-offset-2">
            <div class="wow fadeInDown" data-wow-delay="0.1s">
              <div class="section-heading text-center">
                <h2 class="h-bold" style="color:white;">Agenda Kegiatan</h2>
                <p style="color:white;">Berikut Merupakan Kegiatan Posyandu Beberapa Hari Kedepan</p>
              </div>
            </div>
            <div class="divider-short"></div>
          </div>
              ...
              <div class="carousel-inner">
                <div class="item active">
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="person-text rel text-light">
                      <img src="https://posyandu.bandungkab.go.id/assets/medicio/img/testimonials/1.jpg" alt="" class="person img-circle" />
                      <a title="" href="#">Anna</a>
                  ...
                  <div class="col-md-4 col-sm-6 hidden-xs">
                    ...
                    <div class="person-text rel text-light">
                      <img src="https://posyandu.bandungkab.go.id/assets/medicio/img/testimonials/2.jpg" alt="" class="person img-circle" />
                  ...
                  <div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
                    ...
                    <div class="person-text rel text-light">
                      <img src="https://posyandu.bandungkab.go.id/assets/medicio/img/testimonials/3.jpg" alt="" class="person img-circle" />
                ...
                <div class="item">
                  <div class="col-md-4 col-sm-6">
                    ...
                    <div class="person-text rel text-light">
                      <img src="https://posyandu.bandungkab.go.id/assets/medicio/img/testimonials/4.jpg" alt="" class="person img-circle" />
                  ...
                  <div class="col-md-4 col-sm-6 hidden-xs">
                    ...
                    <div class="person-text rel text-light">
                      <img src="https://posyandu.bandungkab.go.id/assets/medicio/img/testimonials/5.jpg" alt="" class="person img-circle" />
                  ...
                  <div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
                    ...
                    <div class="person-text rel text-light">
                      <img src="https://posyandu.bandungkab.go.id/assets/medicio/img/testimonials/6.jpg" alt="" class="person img-circle" />
...
<div class="container">
    ...
    <div class="col-sm-6 col-md-4">
        ...
        <div class="widget">
            ...
            <p>
            Posyandu merupakan salah satu bentuk Upaya Kesehatan Berbasis Masyarakat (UKBM) yang dikelola dan diselenggarakan dari, oleh, untuk dan bersama masyarakat dalam penyelenggaraan pembangunan.
            </p>
        </div>
        </div>
        <div class="wow fadeInDown" data-wow-delay="0.1s">
        ...
        <div class="widget">
            ...
            <li>
                <span class="fa-stack fa-lg">
                            ...
                            </span> Senin - Jumat, 8.00 Sampai 16.00 WIB
            </li>
            <li>
                <span class="fa-stack fa-lg">
                                <i class="fa fa-circle fa-stack-2x"></i>
    ...
    <div class="col-sm-6 col-md-4">
        ...
        <div class="widget">
            <h5>Lokasi</h5>
            <p>
            Dinas Pemberdayaan Masyarakat dan Desa <br> Jl. Raya Soreang KM 17, Pamekaran, Kec. Soreang, Bandung, Jawa Barat 40912</p>
...
<footer class="main-footer">
  <div class="container">
    ...
    <!-- <script src="https://posyandu.bandungkab.go.id/assets/medicio/js/jquery.min.js"></script> -->
    <script src="https://posyandu.bandungkab.go.id/assets/medicio/js/bootstrap.min.js"></script>
    <script src="https://posyandu.bandungkab.go.id/assets/medicio/js/jquery.easing.min.js"></script>
    <script src="https://posyandu.bandungkab.go.id/assets/medicio/js/wow.min.js"></script>
    <script src="https://posyandu.bandungkab.go.id/assets/medicio/js/jquery.scrollTo.js"></script>
    <script src="https://posyandu.bandungkab.go.id/assets/medicio/js/jquery.appear.js"></script>
    <script src="https://posyandu.bandungkab.go.id/assets/medicio/js/stellar.js"></script>
    <script src="https://posyandu.bandungkab.go.id/assets/medicio/plugins/cubeportfolio/js/jquery.cubeportfolio.min.js"></script>
    <script src="https://posyandu.bandungkab.go.id/assets/medicio/js/owl.carousel.min.js"></script>
    <script src="https://posyandu.bandungkab.go.id/assets/medicio/js/nivo-lightbox.min.js"></script>
    <script src="https://posyandu.bandungkab.go.id/assets/medicio/js/custom.js"></script>
